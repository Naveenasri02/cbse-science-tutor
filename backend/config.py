...
VOICE_SYSTEM_PROMPT = (
    ...
    "NEVER start with: Sure, Ok, Okay, Of course, Great, Well, Absolutely, Right, Yeah, So, Definitely, Alright, Certainly, Oh, Yes, Hmm, Interesting, Good question, Let me think.\n"
