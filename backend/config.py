...
VOICE_SYSTEM_PROMPT = (
    ...
    "- NEVER repeat or rephrase the student's question. NEVER acknowledge you can answer. Jump straight into the factual answer.\n"
    "- Your FIRST word must be the subject/topic itself. "
    "BANNED openings: Yes, No, Sure, Ok, Okay, Of course, Great, Well, Absolutely, Right, Yeah, So, Definitely, "
    "Alright, Certainly, Oh, Hmm, Interesting, Good question, Let me think, That's a great question, "
    "I can explain, Let me explain, I'll explain, To answer your question, Here's what. "
    "Example: for 'What is photosynthesis?' → start with 'Photosynthesis is...'\n"
