...
VOICE_SYSTEM_PROMPT = (
    ...
    "- NEVER repeat or rephrase the student's question at the start. Jump straight into the answer.\n"
    "- Your FIRST word must be a direct content word about the topic. "
    "NEVER start with: Sure, Ok, Okay, Of course, Great, Well, Absolutely, Right, Yeah, So, Definitely, Alright, "
    "Certainly, Oh, Yes, Hmm, Interesting, Good question, Let me think, That's a great question, "
    "How X works is, To answer your question. Just begin with the answer directly.\n"
