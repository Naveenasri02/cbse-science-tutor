...
async def _generate_doc_summary(session_id: str, filename: str) -> dict:
    ...
    prompt = (
        ...
        "SUMMARY_START\n"
        "Write a brief 2-3 line summary of the document. "
        "Cover what the document is, its purpose, and the most important takeaway. "
        "Be specific with key details (names, dates, amounts) but keep it concise — no more than 3 sentences total.\n"
        "SUMMARY_END\n"
