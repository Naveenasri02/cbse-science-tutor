...
async def _generate_doc_summary(session_id: str, filename: str) -> dict:
    ...
    prompt = (
        ...
        "STRICT REQUIREMENT for Q1-Q5: each question MUST be answerable using ONLY text that\n"
        "appears DIRECTLY in the document above. Do NOT generate hypothetical questions, what-if\n"
        "scenarios, predictions, or questions whose answers rely on outside knowledge or inference.\n"
        "If you cannot phrase a question whose answer is literally stated in the document, omit it.\n"
        "Q1: <question whose answer is a specific fact stated in the document>\n"
        "Q2: <question about a specific detail, value, or requirement explicitly stated>\n"
        "Q3: <question about content of a specific section, clause, or topic in the document>\n"
        "Q4: <question comparing or contrasting elements explicitly mentioned in the document>\n"
        "Q5: <question about a conclusion, finding, or recommendation explicitly stated in the document>\n"
        "/no_think"
    )
